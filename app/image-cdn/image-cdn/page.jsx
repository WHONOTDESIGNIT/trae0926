...
// 将这些逻辑移到组件内部以避免 workUnitAsyncStorage 错误
function getSampleImageSrcSet() {
...
export default function Page() {
    // 在组件内部获取 srcSet 以避免 workUnitAsyncStorage 错误
    const sampleImageSrcSet = getSampleImageSrcSet();
